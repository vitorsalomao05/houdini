...
- [x] **Priority maintenance — site build dependencies:** Astro 7.3.3, Sharp
  0.35.4 and affected transitives updated; npm audit now reports zero affected
  packages. Independent reviews and Node 22/24 CI passed. The integrated site
  passed all 76 production HTTP checks with image, navigation and guided-install
  verification; native v1.1.0 and paused WIPs remain preserved. Evidence and
  migration sources: [maintenance validation](docs/validation/site-build-dependencies-2026-09-21.md).
